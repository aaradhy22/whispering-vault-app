...
@media (max-width: 768px) {
    ...
    .secret-input {
        width: 85%;
        font-size: 1.6em;
        letter-spacing: 8px; /* IMPORTANT: Reduce spacing on mobile */
        padding: 12px 10px;
    }
    .secret-input::placeholder {
...
<body>
	...
	<div class="content">
		<h1>Forge Your Secret Key</h1>
		<p>This code will be the only key to your hidden world. Choose it wisely, for it will guard the whispers you're yet to write.</p>
		
		<form action="Setup" method="post" class="form-container" id="secretForm" onsubmit="return validateForm()">
			<input 
                type="text" 
                name="generated_code" 
                class="secret-input" 
                ...
                id="secretCodeInput"
                autocomplete="off"
                value="<% String code = (String) request.getParameter("generated_code"); if(code != null) out.print(code); %>"
            />
			...
			<button type="submit" class="submitBtn">Seal the Lock</button>
		</form>
	...
	<script>
        // The script is correct and does not need changes.
        ...
        function validateForm() {
            errorMessage.textContent = ''; errorMessage.style.opacity = '0';
            if (!form.checkValidity()) {
                errorMessage.textContent = "Your key must be exactly 6 digits.";
